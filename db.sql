...
INSERT INTO `bookmarks` VALUES (00003,00021,00035,'ru','2018-07-18 17:35:14'),(00003,00023,00079,'ru','2018-07-18 17:35:14'),(00003,00025,00037,'ru','2018-07-18 17:35:14'),(00006,00021,02000,'ru','2018-07-18 17:35:14'),(00007,00025,00623,'ru','2018-07-18 17:35:14'),(00001,00017,00002,'ru','2018-07-18 17:35:14'),(00001,00018,00003,'en','2018-07-23 13:50:09'),(00001,00019,00004,'en','2018-07-18 18:15:08'),(00001,00022,00003,'en','2018-07-18 17:56:57'),(00001,00017,00003,'en','2018-07-23 13:53:11'),(00001,00023,00002,'en','2018-07-23 13:53:24'),(00001,00021,00002,'en','2018-07-23 13:53:37'),(00001,00024,00003,'en','2018-07-23 13:53:53'),(00001,00020,00002,'en','2018-07-23 13:55:38'),(00001,00025,00002,'en','2018-07-23 13:55:38'),(00001,00038,00002,'en','2018-07-23 13:55:38'),(00001,00042,00002,'en','2018-07-23 13:55:38'),(00001,00047,00002,'en','2018-07-23 13:55:38');
...
) ENGINE=InnoDB AUTO_INCREMENT=61 DEFAULT CHARSET=utf8 COMMENT='Книги.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `books_has_genres` VALUES (00017,00001),(00017,00002),(00048,00002),(00018,00003),(00019,00004),(00020,00005),(00047,00005),(00020,00006),(00047,00006),(00021,00007),(00022,00008),(00047,00008),(00023,00009),(00047,00009),(00024,00010),(00024,00011),(00025,00012);
...
) ENGINE=InnoDB AUTO_INCREMENT=74 DEFAULT CHARSET=utf8 COMMENT='Новости библиотеки';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8 COMMENT='Пользователи.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `users` VALUES (00001,'admin','e00cf25ad42683b3df678c61f42c6bda','Nikita','Shkonda','admin@admin.com','2018-06-19 20:46:38',NULL,001),(00003,'GipFel','6968978a9a535d7fe9facc1f54b84b94','Inav','Vasiliev','vasya@mail.ru','2018-06-22 19:27:33',NULL,002),(00004,'franceMan','c4680909f48901a488488e83848070cf','Vasiliy','Ivanov','vasya@mail.ru','2018-06-22 19:28:45',NULL,002),(00005,'qwerty','d8578edf8458ce06fbc5bb76a58c5ca4','Semion','Petrov','qwerty@mail.ru','2018-06-22 19:29:17',NULL,002),(00006,'EnglishMan','a6af6634b1b845ecb118e55f151396aa','Viktor','Surich','man@mail.ru','2018-06-22 19:29:50',NULL,003),(00007,'FromBelarus','7823e19fadfd9066779b7c2c28412f6d','Eugene','Bulbash','by@mail.ru','2018-06-22 19:30:28',NULL,003),(00014,'man','7823e19fadfd9066779b7c2c28412f6d','Eugene','Bulbash','by@mail.ru','2018-06-22 19:31:28',NULL,003),(00015,'man1','7823e19fadfd9066779b7c2c28412f6d','Eugene','Bulbash','by@mail.ru','2018-06-22 19:32:28',NULL,003),(00016,'man2','7823e19fadfd9066779b7c2c28412f6d','Eugene','Bulbash','by@mail.ru','2018-06-22 19:33:28',NULL,003),(00017,'man3','7823e19fadfd9066779b7c2c28412f6d','Eugene','Bulbash','by@mail.ru','2018-06-22 19:34:28',NULL,003),(00018,'man4','7823e19fadfd9066779b7c2c28412f6d','Eugene','Bulbash','by@mail.ru','2018-06-22 19:35:28',NULL,003),(00019,'man5','7823e19fadfd9066779b7c2c28412f6d','Eugene','Bulbash','by@mail.ru','2018-06-22 19:36:28',NULL,002),(00020,'woman','7823e19fadfd9066779b7c2c28412f6d','Eugene','Bulbashowa','by@mail.ru','2018-07-14 15:00:04',NULL,003);
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `add_book`(in name nvarchar(100), in description TEXT, in publish_year smallint, in authors nvarchar(100),
							 in price decimal(5,2), in pages smallint, in publishing_house_name nvarchar(50),
                             in pdf_file_url nvarchar(75), in cover_url nvarchar(75), in text_file_url nvarchar(75), out book_id smallint)
BEGIN
	DECLARE publishing_house_id smallint;

	if (!exists (SELECT publishing_houses.publishing_house_id FROM publishing_houses WHERE publishing_houses.name = publishing_house_name)) THEN
		INSERT INTO publishing_houses (`name`) VALUES (publishing_house_name);
	END IF;
	
    set publishing_house_id = (SELECT publishing_houses.publishing_house_id FROM publishing_houses WHERE publishing_houses.name = publishing_house_name);
    
	INSERT INTO `books` 
		   (`def_name`, `def_description`, `publish_year`, `price`, `pages`, `publishing_house_id`, `def_pdf_file_url`, `cover_url`, `def_text_file_url`, `def_authors`) 
	VALUES (name, description, publish_year, price, pages, publishing_house_id, pdf_file_url, cover_url, text_file_url, authors);
	
    set book_id =  (select books.book_id from books 
					where books.def_name=name AND books.def_description=description AND books.publish_year=publish_year AND books.def_authors = authors AND
						  books.price=price AND books.pages=pages AND books.publishing_house_id=publishing_house_id AND 
						  books.def_pdf_file_url=pdf_file_url AND books.cover_url=cover_url AND books.def_text_file_url=text_file_url);
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `add_book_genre`(in genre_id smallint, in book_id smallint)
BEGIN	
	INSERT INTO `books_has_genres` (`book_id`, `genre_id`) VALUES (book_id, genre_id);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `add_news`(in title nvarchar(100), in `text` TEXT, in photo_url nvarchar(75), in thumbs_url nvarchar(75), in user_id smallint, out news_id smallint)
BEGIN
	INSERT INTO `news` (`def_title`, `def_text`, `publish_date`, `user_id`, `photo_url`, `thumbs_url`) VALUES (title, `text`, NOW(), user_id, photo_url, thumbs_url);
    set news_id = (select news.news_id from news where news.def_title = title AND news.def_text = text AND news.user_id=user_id AND news.photo_url = photo_url AND news.thumbs_url = thumbs_url);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `add_translated_book`(in book_id smallint,  in lang nvarchar(2), in name nvarchar(100), in authors nvarchar(100),
																  in description TEXT, in pdf_file_url nvarchar(75),  in text_file_url nvarchar(75))
BEGIN
	INSERT INTO `tbooks` (`book_id`, `lang`, `name`, `description`, `pdf_file_url`, `text_file_url`, `authors`) VALUES (book_id, lang, name, description, pdf_file_url, text_file_url, authors);
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `add_translated_news`(in news_id smallint, in title nvarchar(100), in `text` TEXT, in lang nvarchar(2))
BEGIN
	INSERT INTO `tnews` (`news_id`, `title`, `text`, `lang`) VALUES (news_id, title, `text`, lang);    
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `add_user`(in login nvarchar(20), in `password` nvarchar(100), in first_name nvarchar(20), in last_name nvarchar(20), in email nvarchar(20), in role_name nvarchar(20))
BEGIN
	DECLARE role_id INT;
    set role_id = 
		(SELECT roles.role_id FROM roles
		WHERE roles.role_name = role_name);
	INSERT INTO users (users.login, users.password, users.first_name, users.last_name, users.email, users.role_id, users.registration_date) 
		VALUES (login, `password`, first_name, last_name, email, role_id, NOW());
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `calc_pages_in_bookmarks`(in count_bookmarks_on_page smallint, in user_id smallint, in lang nvarchar(2), out result smallint)
BEGIN
	DECLARE count_bookmarks smallint;
  	
	set count_bookmarks = (select count(bookmarks.book_id) from bookmarks where bookmarks.user_id = user_id  AND bookmarks.lang = lang);
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `calc_pages_in_books`(in count_books_on_page smallint, in lang nvarchar(2), out result smallint)
BEGIN
	DECLARE count_books smallint;
    DECLARE def_lang nvarchar(2) DEFAULT 'en';
    
	IF (lang = def_lang) THEN
		set count_books = (select count(books.book_id) from books);
    ELSE
		set count_books = (select count(tbooks.book_id) from tbooks where tbooks.lang = lang);
    END IF;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `calc_pages_in_book_search`(in search NVARCHAR(100), in lang nvarchar(2), in count_books_on_page smallint, out result smallint)
BEGIN
	DECLARE count_books smallint;
    DECLARE def_lang nvarchar(2) DEFAULT 'en';
    
	IF (lang = def_lang) THEN
		set count_books = (select count(b.book_id) from (SELECT books.book_id FROM books WHERE MATCH (def_name) AGAINST (search IN NATURAL LANGUAGE MODE)) as b);
    ELSE
		set count_books = (select count(tb.book_id) from (SELECT tbooks.book_id FROM tbooks WHERE MATCH (`name`) AGAINST (search IN NATURAL LANGUAGE MODE) AND tbooks.lang = lang) as tb);
    END IF;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `calc_pages_in_news`(in count_news_on_page smallint, in lang nvarchar(2), out result smallint)
BEGIN
	DECLARE count_news smallint;
    DECLARE def_lang nvarchar(2) DEFAULT 'en';
    
	IF (lang = def_lang) THEN
		set count_news = (select count(news.news_id) from news);
    ELSE
		set count_news = (select count(tnews.news_id) from tnews where tnews.lang = lang);
    END IF;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `calc_pages_in_users`(in count_users_on_page smallint, out result smallint)
BEGIN
	DECLARE count_users smallint;
    
    set count_users = (SELECT  COUNT(users.user_id)	
		FROM users);
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `calc_pages_in_users_search`(in search NVARCHAR(100), in count_users_on_page smallint, out result smallint)
BEGIN
	DECLARE count_users smallint;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `change_user_role`(in user_id smallint, in role_name NVARCHAR(100))
BEGIN
	UPDATE users SET
	role_id=(SELECT role_id from roles where roles.role_name=role_name)
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `delete_bookmark`(in user_id smallint, in book_id smallint, in lang varchar(2))
BEGIN
	DELETE FROM bookmarks WHERE bookmarks.book_id=book_id AND bookmarks.user_id=user_id AND bookmarks.lang=lang;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN	
	delete from books_has_genres where books_has_genres.book_id = book_id;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
	delete from news where news.news_id=news_id;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `find_book`(in search NVARCHAR(100), in lang NVARCHAR(2), in count_books_on_page smallint, in number_of_page smallint)
BEGIN
	DECLARE def_lang nvarchar(2) DEFAULT 'en';    
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `find_user`(in search NVARCHAR(100), in count_users_on_page smallint, in number_of_page smallint)
BEGIN 
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `get_bookmark`(in user_id smallint, in book_id smallint, in lang nvarchar(2))
BEGIN
	select bookmarks.page_number from bookmarks
    where bookmarks.user_id = user_id AND bookmarks.book_id = book_id AND bookmarks.lang = lang;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `get_book_genres`(in book_id smallint, in lang varchar(2))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `get_list_of_bookmarks`(in user_id smallint, in lang nvarchar(2), in count_bookmarks_on_page smallint, in number_of_page smallint)
BEGIN
	DECLARE number_of_first_bookmark int;
    set number_of_first_bookmark = (number_of_page-1)*count_bookmarks_on_page;

	select bookmarks.book_id, bookmarks.page_number from bookmarks
    where bookmarks.user_id = user_id  AND bookmarks.lang = lang
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `get_list_of_books`(IN lang nvarchar(2), in count_books_on_page smallint, in number_of_page smallint)
BEGIN
	DECLARE def_lang nvarchar(2) DEFAULT 'en';    
    DECLARE number_of_first_books int;
    set number_of_first_books = (number_of_page-1)*count_books_on_page;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `get_list_of_users`(in count_users_on_page smallint, in number_of_page smallint)
BEGIN
	DECLARE number_of_first_user int;
    set number_of_first_user = (number_of_page-1)*count_users_on_page;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `get_news`(in news_id smallint, in lang nvarchar(2))
BEGIN
	DECLARE def_lang nvarchar(2) DEFAULT 'en';
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `get_url_to_text_of_book`(in book_id smallint, in lang nvarchar(2))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `is_administrator`(in login NVARCHAR(20), out result boolean)
BEGIN
	DECLARE role_name nvarchar(15) DEFAULT 'Administrator';
	if (exists (SELECT user_id FROM users WHERE users.login=login AND users.role_id = 
    (SELECT roles.role_id from roles where roles.role_name=role_name)
    )) THEN
		set result = true;
    else
		set result = false;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `is_exist_user`(in login NVARCHAR(20), in password NVARCHAR(100), out result boolean)
BEGIN
	if (exists (SELECT user_id FROM users WHERE users.login=login AND users.password=password)) THEN
		set result = true;
    else
		set result = false;
	END IF;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `is_free_login`(in login NVARCHAR(20), out result boolean)
BEGIN
	if (exists (SELECT user_id FROM users WHERE users.login=login)) THEN
		set result = false;
    else
		set result = true;
	END IF;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `is_moderator`(in login NVARCHAR(20), out result boolean)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `set_bookmark`(in user_id smallint, in book_id smallint, in lang nvarchar(2), in page_number smallint)
BEGIN
	if (exists (SELECT user_id FROM bookmarks WHERE bookmarks.user_id = user_id AND bookmarks.book_id = book_id AND bookmarks.lang = lang)) THEN
		UPDATE bookmarks SET bookmarks.page_number = page_number, bookmarks.last_update = NOW() WHERE bookmarks.user_id = user_id AND bookmarks.book_id = book_id AND bookmarks.lang = lang;
    else
		INSERT INTO `bookmarks` (`user_id`, `book_id`, `page_number`, `lang`, `last_update`) VALUES (user_id, book_id, page_number, lang, NOW());
	END IF;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `update_book`( in book_id smallint, in name nvarchar(100), in description TEXT, in publish_year smallint, in authors nvarchar(100),
							 in price decimal(5,2), in pages smallint, in publishing_house_name nvarchar(50),
                             in pdf_file_url nvarchar(75), in cover_url nvarchar(75), in text_file_url nvarchar(75))
BEGIN
	DECLARE publishing_house_id smallint;
    ...
    UPDATE books SET books.def_name=name, books.def_description=description, books.publish_year=publish_year, 
						  books.price=price, books.pages=pages, books.publishing_house_id=publishing_house_id, 
						  books.def_pdf_file_url=pdf_file_url, books.cover_url=cover_url, books.def_text_file_url=text_file_url, books.def_authors=authors WHERE books.book_id = book_id;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `update_news`(in news_id smallint, in title nvarchar(100), in `text` TEXT, in photo_url nvarchar(75), in thumbs_url nvarchar(75), in user_id smallint)
BEGIN
    UPDATE news SET news.def_title = title, news.def_text = text, news.user_id=user_id, news.photo_url = photo_url, news.thumbs_url = thumbs_url, news.publish_date = NOW() WHERE news.news_id = news_id;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `update_translated_book`(in book_id smallint,  in lang nvarchar(2), in name nvarchar(100), in authors nvarchar(100),
																  in description TEXT, in pdf_file_url nvarchar(75),  in text_file_url nvarchar(75))
BEGIN
	UPDATE tbooks SET tbooks.name=name, tbooks.description=description, tbooks.pdf_file_url=pdf_file_url, tbooks.text_file_url=text_file_url, tbooks.authors=authors
    WHERE tbooks.book_id = book_id AND tbooks.lang = lang;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `update_translated_news`(in news_id smallint, in title nvarchar(100), in `text` TEXT, in lang nvarchar(2))
BEGIN
    UPDATE tnews 
    SET tnews.title = title, tnews.text = text
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `update_user`(in login varchar(20), in password varchar(100), in first_name varchar(20), in last_name varchar(20), in email varchar(50))
BEGIN	
	UPDATE users SET users.`password`=`password`, users.first_name = first_name, users.last_name = last_name, users.email = email WHERE users.login = login;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
-- Dump completed on 2018-07-27 20:56:28
