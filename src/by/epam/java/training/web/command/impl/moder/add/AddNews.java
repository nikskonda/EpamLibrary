...
import static by.epam.java.training.web.command.CommandConstants.GO_TO_ADD_NEWS_FORM;
    ...
    public void execute(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        try{
            ...
            if (!userService.isUserExist(new SignInForm(user.getLogin(), password))){
                ...
                CommandFactory.getCommand(GO_TO_ADD_NEWS_FORM).execute(request, response);
                return;
            }
