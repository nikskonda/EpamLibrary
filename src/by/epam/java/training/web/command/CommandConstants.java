...
public class CommandConstants {
    ...
    //book
    public static final String TAKE_BOOK_CATALOG = ("open_book_catalog");
    public static final String FIND_BOOKS = ("find_book");
    public static final String TAKE_BOOK = ("open_book");
    ...
    //news
    public static final String TAKE_LIST_OF_NEWS = ("open_news_list");
    public static final String TAKE_NEWS = ("open_news");
